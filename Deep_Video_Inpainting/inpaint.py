...
from Deep_Video_Inpainting.inpainting.utils import *
...
def inpaint(args):
    ...
    opt.pretrain_path = 'Model_CP/save_agg_rec_512.pth'
    opt.result_path = './' + args.data + '_inpaint_result'
    ...
    print('Deep Video Inpainting, number of model parameters: {}'.format(sum([p.data.nelement() for p in model.parameters()])))
