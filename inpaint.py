...
from Deep_Video_Inpaiting.inpainting.davis import DAVIS
from Deep_Video_Inpaiting.inpainting.model import generate_model
from Deep_Video_Inpaiting.inpainting.utils import *

# import argparse

# parser = argparse.ArgumentParser(description='Demo')

# parser.add_argument('--resume', default='Deep_Video_Inpaiting/cp/SiamMask_DAVIS.pth', type=str,
...
def inpaint(args):
    ...
    opt.pretrain_path = 'Deep_Video_Inpaiting/cp/save_agg_rec_512.pth'
    opt.result_path = 'images/inpaint_result'
    ...
    with torch.no_grad():
        for seq, (inputs, masks, info) in enumerate(DTloader):
            ...
            save_path = os.path.join(opt.result_path)
